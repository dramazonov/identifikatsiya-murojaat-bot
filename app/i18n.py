...
_MESSAGES: dict[str, dict[str, str]] = {
    ...
    "appeal.attachment_prompt": {
        "uz_latn": "📎 Zarur bo‘lsa bitta PDF hujjat yuboring. Kerak bo‘lmasa «O‘tkazib yuborish»ni bosing.",
        "uz_cyrl": "📎 Зарур бўлса битта PDF ҳужжат юборинг. Керак бўлмаса «Ўтказиб юбориш»ни босинг.",
        "ru": "📎 При необходимости отправьте один PDF-документ. Если файл не нужен, нажмите «Пропустить».",
        "en": "📎 Optionally send one PDF document. If no file is needed, tap “Skip”.",
    },
    "appeal.attachment_invalid": {
        "uz_latn": "Faqat bitta PDF fayl qabul qilinadi.",
        "uz_cyrl": "Фақат битта PDF файл қабул қилинади.",
        "ru": "Принимается только один PDF-файл.",
        "en": "Only one PDF file is accepted.",
    },
    "appeal.attachment_too_large": {
        "uz_latn": "PDF fayl hajmi juda katta. 20 MB gacha bo‘lishi mumkin.",
        "uz_cyrl": "PDF файл ҳажми жуда катта. 20 MB гача бўлиши мумкин.",
        "ru": "PDF-файл слишком большой. Допустимый размер — до 20 МБ.",
        "en": "The PDF file is too large. Maximum size is 20 MB.",
    },
